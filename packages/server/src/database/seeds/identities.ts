/**
 * Generated with:
 * pnpm keygen identity --userId alice  --mainKey jcef-s6GavZu_Pge5MzQW7e1R_kLgIYLTbCtTi0X8uA
 * pnpm keygen identity --userId bob    --mainKey 7d-0d8n5DDHbCpA46pGVbz9_Fdy3QEDC9AuPBbloygM
 * pnpm keygen identity --userId carol  --mainKey IihRh3WbEp8rPxC13WjPNC2Droqqc20Zv45O_4eqerQ
 * pnpm keygen identity --userId daniel --mainKey bkpg1y2AvkGP-M7P44YGm7ZWUexRSBR9qoYgYAGaW4Y
 */
...
export const SEED_USERS = [
  {
    ...
    identity: {
      ...
      proof:
        'sW_0G8YqIaUI7PGIE9wPdVawj5FCAVqDq9SIAZSPgEAE_u53SbcgNnEBtSiO4Ei16gM5vFeXsnM0GYHebj86Dw',
    },
  },
  {
    ...
    identity: {
      ...
      proof:
        'E1d3W1WTo3dMOt9VHABsCHoKfMeVEJBy9hCGBZfTPB33T-yPzsIdSerNu53cbsFEvXSiKeSrLozcfP5A5gkeDA',
    },
  },
  {
    ...
    identity: {
      ...
      proof:
        'WfSzjdmKNpuMqpmBLACvrIsYugWh0tTmfJKv_EAdCQZz7Hj5mB_7fRH48wJ5sWTGHe0dKFZ_ZSiZRJ9xsKejCg',
    },
  },
  {
    ...
    identity: {
      ...
      proof:
        'LUPuIFgpnpkgRMIdpqHAK06Y83UkjDaQhzZMOxSCOt8OlR_kgKROoXYx0C1Tu9G_jHZk6VhysrGBH02U5iy8CQ',
    },
  },
]
